...
if choice == "othello":
    g=OthelloGame(4)
    n1 = NNet2(g)
    n1.load_checkpoint('./temp/', 'curent3temp:iter75:eps115:dim4.pth.tar')
    display=display2
    hp = MinMaxOthelloPlayer(g,15).play
if choice == "connect4":
    g=Connect4Game(6,7)
    n1=NNet3(g)
...
# nnet players
args1 = dotdict({'numMCTSSims': 700, 'cpuct':1.0,'epsilon': 0,'dirAlpha':0.3})
